...
python3 - <<'PY'
import os, importlib.util, importlib, slime
root = os.path.dirname(slime.__file__)
print("slime:", slime.__file__)
print("utils_dir:", os.path.isdir(os.path.join(root, "utils")))
print("utils_py:", os.path.isfile(os.path.join(root, "utils.py")))
print("spec slime.utils:", importlib.util.find_spec("slime.utils"))
print("spec slime.utils.prefix_tree_merging_utils:",
importlib.util.find_spec("slime.utils.prefix_tree_merging_utils"))
m = importlib.import_module("slime.utils.prefix_tree_merging_utils")
print("ptm:", m.__file__)
PY
PERF_ARGS=(
