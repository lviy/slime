...
def main():
    ...
    # === Fix for "CPU RNG state changed within GPU RNG context" spam ===
    try:
        logging.getLogger("megatron.core.tensor_parallel.random").setLevel(logging.ERROR)
        print("Suppressed megatron.core.tensor_parallel.random logs.")
    except Exception as e:
        print(f"Failed to suppress random logs: {e}")
    # =================================================================
