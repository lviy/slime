...
export SLIME_PTM_ROLLOUT_MODEL_PATH="${SLIME_PTM_ROLLOUT_MODEL_PATH:-${SLIME_PTM_ROLLOUT_BASE_DIR}/Qwen2.5-0.5B-Instruct}"
export SLIME_PTM_ROLLOUT_REF_PATH="${SLIME_PTM_ROLLOUT_REF_PATH:-${SLIME_PTM_ROLLOUT_BASE_DIR}/Qwen2.5-0.5B-Instruct/}"
...
export SLIME_PTM_ROLLOUT_DUMP_DIR="${SLIME_PTM_ROLLOUT_DUMP_DIR:-/tmp/qwen25_05b_ptm_rollout}"
...
export SLIME_PTM_ROLLOUT_NUM_GPUS_PER_ENGINE="${SLIME_PTM_ROLLOUT_NUM_GPUS_PER_ENGINE:-1}"
...
export SLIME_PTM_ROLLOUT_MAX_RESPONSE_LEN="${SLIME_PTM_ROLLOUT_MAX_RESPONSE_LEN:-1024}"
export SLIME_PTM_ROLLOUT_MAX_TOKENS_PER_GPU="${SLIME_PTM_ROLLOUT_MAX_TOKENS_PER_GPU:-8192}"
...
export SLIME_PTM_ROLLOUT_MAX_RUNNING_REQUESTS="${SLIME_PTM_ROLLOUT_MAX_RUNNING_REQUESTS:-128}"
